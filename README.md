...
Configure weights and priorities appropriately (the examples have a difference of 5 between primary and secondary and a weight of -10, achieving takeover of secondary if primary's check script fails).
